 ...
 * @author mike
 */
public class DodgyInputStream extends InputStream {
    
    /**
     * Actual input stream where we get out input data
     */
    ...
    public int read() throws IOException {
        ...
        return srcStream.read();
    }

    @Override
    public long skip(long n) throws IOException {
        return srcStream.skip(n);
    }
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        ...
        int streamReadCount = srcStream.read(b, off, len);
